...
func (_m *Signer) SignTx(ctx context.Context, tx *types.Transaction) (*types.Transaction, error) {
...
func (_c *Signer_SignTx_Call) Run(run func(ctx context.Context, tx *types.Transaction)) *Signer_SignTx_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Signer_SignTx_Call) Return(_a0 *types.Transaction, _a1 error) *Signer_SignTx_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Signer_SignTx_Call) RunAndReturn(run func(context.Context, *types.Transaction) (*types.Transaction, error)) *Signer_SignTx_Call {
	_c.Call.Return(run)
	return _c
}
